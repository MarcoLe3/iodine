...
const TOOL_NARRATION_PHRASES: Record<string, string[]> = {
  ...
  edit_file: [
    ...
    'Let me revise {file}.', 'I’ll put that fix into {file}.', 'Let me tune up {file}.',
    'I’m making the requested change in {file}.', 'Let me reshape that section of {file}.',
    'I’ll adjust the implementation in {file}.', 'Let me improve this part of {file}.',
    'I’m editing {file} with that in mind.', 'Let me apply a focused change to {file}.',
    'I’ll update the code in {file}.', 'Let me work that into {file}.',
    'I’m revising the relevant lines in {file}.', 'Let me clean up {file}.',
    'I’ll make the necessary adjustment in {file}.', 'Let me incorporate that into {file}.',
    'I’m modifying {file} now.', 'Let me take care of the change in {file}.',
  ],
  write_file: [
